package com.zuci.halo.views.dashboard;
...
@ParentLayout(NavBarView.class)
@Route(value = "dashboard" , layout = NavBarView.class)
@PageTitle("Dashboard")
public class DashboardView extends AppLayout implements RouterLayout{
	...
	private static Tab[] getAvailableTabs() {
		return new Tab[] { createTab("Data", DataQualityReportsView.class),
				createTab("Features", FeatureQualityReportsView.class),
				createTab("Model", ModelQualityReportsView.class) };
	}
